                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px0">
                            <h3 class="text-lg text-gray-900">Tickets Recibidos</h3>
                            <p class="text-sm text-gray-600">Aquí puedes ver todos los tickets que te hayan mandado</p>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($tickets as $ticket)
                                        <tr class="border odd:bg-white even:bg-slate-200">
                                            ...
                                            <td class="">{{ $ticket->department->name }}</td>
                                            <td class="">usuario</td>
                                            {{-- <td class="px-4 py-2"><a href="">Ver ticket</a></td> --}}
                                            <td class=""><a href="{{ route('tickets.show', $ticket->id) }}"class="{{ $button_see }}">Ver</a></td>
                                            <td><a href="{{ route('tickets.edit', $ticket->id) }}" class="{{ $button_edit }}">Editar</a></td>
