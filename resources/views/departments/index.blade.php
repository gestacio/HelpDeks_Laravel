                ...
                <div class="md:grid md:grid-cols-7 md:gap-1 mx-3">
                    <div class="md:col-span-3">
                        <div class="px-4 sm:px0">
                            <h3 class="text-lg text-gray-900 mx-3">Creación de departamentos</h3>
                            <p class="text-sm text-gray-600 mx-3">Aquí puedes departamentos nuevos para el sistema</p>
                    ...
                    <div class="md:col-span-4">
                        <h3 class="text-lg text-gray-900 mx-3">Departamentos</h3>
                        <p class="text-sm text-gray-600 mx-3">Aquí puedes ver departamentos en el sistema</p>
                        ...
                        <div class="shadow bg-white md:rounded-md p-4 my-3">
                            <div class="flex justify-between">
                                ...
                                <a href="{{ route('departments.create') }}" class="{{ $button_create }}">
                                    Crear
                                </a>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($departments as $department)
                                        <tr class="border odd:bg-white even:bg-slate-200 mx-auto">
                                            <td class="px-2 py-4 text-sm"><p class="">{{ $department->name }}</p></td>
